      ...
      <div className="flex items-center justify-between mb-2">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Compare BP&apos;s SOX posture to industry benchmarks and identify key gaps.
          </p>
        </div>
          ...
          <div className="xl:col-span-1 space-y-4">
                ...
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-2 text-xs text-muted-foreground">
                      Overall SOX control posture based on identified gaps and benchmarks.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col items-end gap-1 text-xs">
                    ...
                    <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-sky-100 text-sky-700">
            ...
            <Card className="p-4 space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                ...
                Deloitte, and PwC across SOX control design, automation, and
                monitoring.
              </p>
            </Card>
          </div>
